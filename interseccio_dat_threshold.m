...
%Intersecció entre les màscares de MRI i Datscan (Treshold)
...
for g = 1:length(groups)
    ...
    for p = 1:length(patientFolders)
        ...
        datPath = fullfile(groupDir, patientID, 'DAT_resampled', ['threshold_manual_' patientID '.nii']);
        ...
        if exist(mriPath, 'file') && exist(datPath, 'file')
            ...
            pct90DATSCAN = prctile(double(mascaraDATSCAN(:)), 90);
            ...
            % Convertir la imatge MRI en màscara lògica basada en la mitjana
